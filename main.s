...
SSI_0_GPIO_PORT_A_F_CLOCK_ON ;reg RCGCGPIO->bit 1 R5=1-> ENABLE AND PROVIDE A CLOCK TO GPIO PORTS A, F IN RUN MODE	
			MOV R0, #0x21	
...
GPIO_A_DIR	;reg GPIODIR->bit  GPIODIR=0B1100.0000 -> SETUP PINS PA6,PA7 AS OUTPUTS
			MOV R0, #0xC0	
...
SSI0_GPIO_PINS_DEN
			...
			STR R0, [R1] 			
SSI0_GPIO_PINS_PCTL
			LDR R1, =GPIO_PORTA_AHB_PCTL_R;2,3,5 SSI
			LDR R0, [R1] 
			MOV32 R2,#0xFF0F00FF
			BIC R0, R2
			MOV32 R2,#0x00202200
